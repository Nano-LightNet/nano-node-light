...
export default class NanoNode extends EventEmitter {
  constructor({ network = constants.NETWORK.BETA, ...config } = {}) {
    ...
    // [BlockHash]: { voters: [ Voting Account(s) ], votingWeight: Total Voting Weight, state: 0 (Unconfirmed) 1 (Confirmed), requestCount: Amount of times Node has requested vote for this Election, started: Time Election Started }
    this.elections = {}
